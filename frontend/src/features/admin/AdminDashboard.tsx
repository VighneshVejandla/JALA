...
const QUICK_LINKS: { to: string; label: string; icon: LucideIcon }[] = [
  ...
  { to: ROUTES.adminReports, label: 'Reports', icon: FileBarChart },
  { to: ROUTES.adminDeliveries, label: 'Deliveries', icon: Truck },
  { to: ROUTES.adminSearch, label: 'Search', icon: Search },
